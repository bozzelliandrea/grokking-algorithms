...
*/
function ten(ll: LinkedNode<number>, occ: number, n: number): LinkedNode<number> {
...
Assert.assertTrue(
    Assert.arraysEqual(
        LinkedNode.toArray(
            ten(LinkedNode.fromArray([2,4,3,2,8,2,5,1,2]), 2, 10)
        ),
...
Assert.assertTrue(
    Assert.arraysEqual(
        LinkedNode.toArray(
            ten(LinkedNode.fromArray([2,4,3,2,8,2,5,1,2]), 2, 2)
        ),
